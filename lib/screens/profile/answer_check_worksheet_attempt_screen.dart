...
class AnswerCheckWorksheetAttemptScreen extends GetView<ResultController> {
  const AnswerCheckWorksheetAttemptScreen({Key? key}) : super(key: key);

  static const String routeName = '/answer-check-worksheet-attempt';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        showActionIcon: true,
        onMenuActionTap: () {
          Get.toNamed(ResultWorksheetAttemptScreen.routeName);
        },
      ),
